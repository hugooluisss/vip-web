<div class="form-horizontal">
			...
			<div class="form-group">
				...
				<label class="col-sm-1 text-right" for="txtNoExt">#ext</label>
				<div class="col-sm-1">
					<input class="form-control input-sm" id="txtNoExt" name="txtNoExt" />
				</div>
				<label class="col-sm-1 text-right" for="txtNoInt">#int</label>
				<div class="col-sm-1">
					<input class="form-control input-sm" id="txtNoInt" name="txtNoInt" />
				</div>
			</div>
			<div class="form-group">
