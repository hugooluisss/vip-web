...
" alt="VIP" style="width: 65px;"/>
					...
					<li class="<?php if (in_array($_smarty_tpl->tpl_vars['PAGE']->value['modulo'],array('productos','controlinventario'))){?>active<?php }?> treeview">
						...
						<ul class="treeview-menu">
							...
							<li <?php if (in_array($_smarty_tpl->tpl_vars['PAGE']->value['modulo'],array('controlinventario'))){?>class="active"<?php }?>><a href="controlinventario">Entradas y salidas de productos</a></li>
						</ul>
					</li>
					...
					<li class="<?php if (in_array($_smarty_tpl->tpl_vars['PAGE']->value['modulo'],array('reporteventas','reporteexistencias','reportepedidos','cobranzaVIP'))){?>active<?php }?> treeview">
						...
						<ul class="treeview-menu">
							...
							<li class="<?php if (in_array($_smarty_tpl->tpl_vars['PAGE']->value['modulo'],array('cobranzaVIP'))){?>active<?php }?>"><a href="cobranzaVIP">Comisiones VIP System</a></li>
						</ul>
					</li>
					<?php }?>
